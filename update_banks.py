...
for bank in data['banks']:
    if bank['bankName'] == 'AU Small Finance Bank':
        # Replace or add templates
        # We need to match:
        # 1. Alert! Your AU Bank A/c No. X9318 has been Debited with INR 71.07 ...
        # 2. Payment of INR 20,685.00 was credited to your Card xx7750 on 12/10/2024.
        bank['templates'].insert(0, {
...
federal_exists = any(b['bankName'] == 'Federal Bank' for b in data['banks'])

if not federal_exists:
    federal_bank = {
    ...
    data['banks'].append(federal_bank)

with open('e:/P-Code/expense_tracker/assets/bank_configs.json', 'w', encoding='utf-8') as f:
