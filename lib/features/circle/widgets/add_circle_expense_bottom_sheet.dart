...
void showAddCircleExpenseBottomSheet({
  ...
  showModalBottomSheet(
    ...
    builder: (context) =>
        AddCircleExpenseBottomSheet(circleId: circleId, members: members),
  );
}

enum SplitType { equal, percentage, fixed }

class AddCircleExpenseBottomSheet extends ConsumerStatefulWidget {
  final int circleId;
  final List<Member> members;

  const AddCircleExpenseBottomSheet({
    super.key,
  ...
  @override
  ConsumerState<AddCircleExpenseBottomSheet> createState() =>
      _AddCircleExpenseBottomSheetState();
}

class _AddCircleExpenseBottomSheetState
    extends ConsumerState<AddCircleExpenseBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final formState = ref.watch(
      addCircleExpenseFormStateProvider(widget.members),
    );
    final formNotifier = ref.read(
      addCircleExpenseFormStateProvider(widget.members).notifier,
    );
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        'SPLIT WITH (${formState.includedMemberIds.length}/${widget.members.length})',
                        style: context.appTexts.bodySmall.copyWith(
                          color: context.colors.textSecondary,
                    ...
                    child: Material(
                      ...
                      child: Column(
                        children: widget.members.map((m) {
                          final isIncluded = formState.includedMemberIds
                              .contains(m.userId);
