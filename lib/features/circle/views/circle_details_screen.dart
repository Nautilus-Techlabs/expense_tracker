      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push(AppRouter.circleSettings, extra: circleName),
          ),
            ...
            child: SafeArea(
              ...
              child: Container(
                ...
                child: PrimaryButton(
                  ...
                  onPressed: () => _showSettleUpBottomSheet(context),
                ),
              ),
            ),
          ),
...
void _showSettleUpBottomSheet(BuildContext context) {
  showModalBottomSheet(
    context: context,
    isScrollControlled: true,
    backgroundColor: Colors.transparent,
    builder: (context) => const _SettleUpBottomSheet(),
  );
}

class _SettleUpBottomSheet extends StatelessWidget {
