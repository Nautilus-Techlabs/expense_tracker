...
void main() {
  ...
  final testCases = [
    {
      ...
      'sms':
          'IDBI Bank Acct XX1234 debited for Rs. 1500.00 towards Amazon for UPI. RRN 123456789012. Bal Rs. 12000.00.',
    ...
    },
    {
      ...
      'parser': HierarchicalBankParser(indusind),
      'sms':
          'INR 1,200.00 has been debited from your IndusInd Bank A/c ending 1234. Avl Bal: INR 20,900.00.',
    ...
    },
    {
      ...
      'sms':
          'Rs. 50.00 debited with JPB A/c x1234 to Merchant. UPI/DR/123456789012. Avl Bal: Rs. 450.00.',
      'expectedAmount': 50.0,
    },
  ];
  ...
  for (var tc in testCases) {
    ...
    final tx = (tc['parser'] as HierarchicalBankParser).parse(
      tc['sms'] as String,
    );
    if (tx == null) {
